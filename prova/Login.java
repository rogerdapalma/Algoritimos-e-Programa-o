...
public class Login extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTFSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if ((pessoa.senha).equals(md5(jTFSenha.getText()))) { //verifica as senhas, e se for iguais, passa
            JOptionPane.showMessageDialog(this, "CANDIDATO JA INSCRIT0");
        } else {
            JOptionPane.showMessageDialog(this, "Senha Incorreta Ou Sem Cadastro, Tente Novamente"); //se nao nao deixa passar
        }
